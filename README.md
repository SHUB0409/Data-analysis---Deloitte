...
Built visualizations showing factory-level and device-level performance trends.

Focused on identifying the most “unhealthy” factories and device types using bar charts and dashboards.
...
Processed all compensation data and generated the Equality Table.xlsx file.

The file includes 3 key columns:

Factory

Job Role

Equality Score (integer ranging from -100 to +100, where 0 represents perfect equality).

Outcome:

Created the base dataset (Task 5 Equality Table.xlsx) used in Tableau to visualize and compare equality scores across locations.
...
Highlighted high-risk factories such as Daikibo-Factory-Meiyo and Daikibo-Factory-Seiko.

Helped management understand operational stress areas through visual comparisons.

2. Device Type Analysis (Sheet 2)

Analyzed the number of unhealthy readings by Device Type.

Identified devices contributing most to factory-level inefficiencies.

3. Integrated Dashboard

Combined both factory and device views into one interactive Tableau dashboard.

Allowed stakeholders to drill down by factory or device for root cause analysis.
...
Microsoft Excel – for forensic equality data preparation and score calculation.

Data Analysis Techniques: Aggregation, Filtering, and KPI comparison.
...
Download the Excel dataset: Task 5 Equality Table.xlsx.

Open Tableau and connect the Excel data source.

Recreate or explore visualizations using these dimensions:
...
This multi-part Deloitte project demonstrates strong skills in:

Data analysis, forensic auditing, and visualization using Tableau and Excel.

Developing equality dashboards to support ethical business practices.

Converting raw operational data into actionable business insights.

👨‍💻 Author

Shubham Kuril
GitHub: https://github.com/SHUB0409
